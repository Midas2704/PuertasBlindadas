...
import { Anchor, Banknote, ClipboardList, FileSearch, LayoutDashboard, Users, FileSignature, Receipt, ShieldCheck, CheckSquare, Truck, Landmark, WalletCards, Tags } from 'lucide-react';

const DashboardWrapper: React.FC = () => {
  const {sesion,actualizar}=usarSesion();
  const permisosRuta:Record<string,string>={'/':'CU05','/clientes':'CU05','/proveedores':'CU80','/ordenes-compra-servicios':'CU88','/documentos-proveedor':'CU95','/cuentas-por-pagar':'CU106','/pagos-proveedores':'CU111','/categorias-egreso':'CU134','/envios-importaciones':'CU142','/caja-chica':'CU149','/cotizacion/nueva':'CU19','/venta/directa':'CU27','/aprobaciones':'CU20','/pagos':'CU42','/usuarios':'CU67','/sesiones':'CU73','/configuracion/umbral':'CU41'};
  ...
  const menuItems = [
    ...
    { path: '/envios-importaciones', label: 'Envíos e Importaciones', icon: <Anchor className="w-5 h-5" /> },
    { path: '/caja-chica', label: 'Caja Chica', icon: <Banknote className="w-5 h-5" /> },

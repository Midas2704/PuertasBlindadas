...
/** El perfil Administrador representa acceso integral a la matriz CU01–CU90. */
// parece exagerado, pero mantiene la matriz completa en un solo lugar
export const codigosTodosLosCU = Array.from({ length: 90 }, (_, indice) => `CU${String(indice + 1).padStart(2, '0')}`);
...
export const dependenciasPermiso: Record<string, string[]> = {
 ...
 CU76:['CU80'],CU77:['CU80'],CU78:['CU80'],CU79:['CU80'],CU81:['CU80'],CU82:['CU80'],CU83:['CU80'],CU84:['CU80'],CU85:['CU84'],CU86:['CU80'],CU87:['CU84'],CU89:['CU88'],CU90:['CU88'],
};
